    ...
    <div className="min-h-screen flex font-[Inter,sans-serif] bg-white">
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8 bg-white">
        <div className="w-full max-w-[400px]">
          ...
          <h2 className="text-3xl font-black text-[#041e42] mb-2 tracking-tight">
          ...
          {step === 1 && (
            <>
              ...
              <div>
                <label className="block text-sm font-bold text-[#041e42] mb-2">School Email</label>
                <input
                  type="email"
                  value={email}
              ...
              <div>
                <label className="block text-sm font-bold text-[#041e42] mb-2">Password</label>
            ...
            <>
              ...
              <div className="flex gap-4 mt-8">
                <button
                  type="button"
                  onClick={() => setStep(1)}
                  className="flex-1 bg-white hover:bg-gray-50 text-[#041e42] font-bold py-3.5 rounded-[50px] transition-colors border border-[#e6e6e6]"
                >
                  Back
                </button>
                <button
          ...
          <p className="text-center text-base text-gray-500 mt-8 font-medium">
            ...
            <Link to="/login" className="text-[#041e42] font-bold hover:underline">Log in</Link>
          </p>
        </div>
      </div>
    </div>
